...
func (s *Service) ReserveEquipment(ctx context.Context, items []domain.ReserveItem) error {
	return s.repository.ReserveEquipment(ctx, items)
}

func (s *Service) ReleaseEquipment(ctx context.Context, items []domain.ReserveItem) error {
	return s.repository.ReleaseEquipment(ctx, items)
}

func (s *Service) CheckAvailability(ctx context.Context, items []domain.ReserveItem) (bool, []int, error) {
	return s.repository.CheckAvailability(ctx, items)
}
